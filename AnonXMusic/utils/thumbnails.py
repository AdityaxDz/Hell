...
async def get_thumb(videoid):
    ...
    try:
        ...
        try:
            ...
            pass
        text_w, text_h = draw.textsize(f"Duration: {duration} Mins {channel} | {views[:23]}", font=arial)
        draw.text(((1280 - text_w)/2, 660), f"Duration: {duration} Mins {channel} | {views[:23]}", fill="white", font=arial)
        draw.line(
            [(55, 660), (1220, 660)],
            fill="white",
            width=5,
